...
def chat():
    try:
      ...
      response_model_max_response_tokens = 150

      query_model_name = 'gpt-3.5-turbo'
      query_model_temperature = .2
      query_model_max_response_tokens = 50
      ...
      full_response = openai.ChatCompletion.create(
          ...
          max_tokens=query_model_max_response_tokens
      )
      end_time = time.time()
      ...
      msg_history_token_count = response_model_context_length - search_results_max_tokens - query_model_max_response_tokens - system_msg_stub_tokens
      ...
      def generate():
        ...
        full_response = openai.ChatCompletion.create(
            ...
            max_tokens=response_model_max_response_tokens,
            stream=True
        )
        
        for chunk in full_response:
          chunk_message = chunk['choices'][0]['delta']
          yield f"data: {chunk_message['content']}\n\n" # This format is for SSE
        end_time = time.time()
