...
export const mockGetJournalEntryByDate = rest.get(
  '/api/journalEntry',
  (req, res, ctx) => {
    return res(
      ctx.status(200),
...
export const mockGetJournalEntryImage = rest.get(
  '/api/journalEntryImage',
  (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json([
...
export const mockGetJournalTopics = rest.get(
  '/api/journalTopic',
  (req, res, ctx) => {
...
export const mockGetStarredEntry = rest.get(
  '/api/starredEntry',
  (req, res, ctx) => {
    const userId = req.url.searchParams.get('userId');
    const journalEntryId = req.url.searchParams.get('journalEntryId');
...
export const mockPostComment = rest.post(
  ...
  async (req, res, ctx) => {
    ...
    return res(ctx.status(200), ctx.json({ userId, postId, text }));
  },
);

export const mockDeleteComment = rest.delete(
  '/api/comment',
  (req, res, ctx) => {
    return res(ctx.status(200), ctx.json({ message: 'success' }));
  },
...
export const mockPostSearch = rest.post(
  '/api/searchEmbeddings',
  (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json({
        results:
          'Date:2023-07-14; Text:first5'.repeat(5) +
          'Date:2023-07-14; Text:second5'.repeat(5),
      }),
    );
  },
);

export const mockPostAuthSession = rest.get(
  '/api/auth/session',
  (req, res, ctx) => {
    return res(ctx.status(200), ctx.json({ message: 'success' }));
  },
...
export const handlers = [
  mockGetJournalEntryByDate,
  mockGetJournalEntryImage,
  mockGetJournalTopics,
  mockGetReadEntry,
  mockGetStarredEntry,
  mockPostSearch,
  mockPostComment,
